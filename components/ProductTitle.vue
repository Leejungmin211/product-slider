<template>
  <div class="flex flex-col items-center justify-center text-center font-medium mb-27">
    <a class="flex justify-center items-center text-28" :href="url">
      <span class="pl-2 pt-2 pb-2">
    ...
    <p class="text-semibold font-normal text-lightGray tracking-tighter"><slot name="subtitle"></slot></p>
  </div>
</template>
